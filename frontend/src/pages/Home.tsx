        ...
        <div className="mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div className="sm:text-center lg:text-left">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="inline lg:hidden text-indigo-600">
                Studiengruppen
              </span>
              <span
                id="typewriter"
              ...
              <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500">
                    ...
                    gut zu verstehen. Um passende Gruppen empfohlen zu bekommen,
                    kannst du in deinem Profil deine Präferenzen einstellen.
                  </dd>
                </div>
