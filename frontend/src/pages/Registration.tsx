...
function Registration({ ...props }) {
  return (
    <div
      className="max-w-7-xl mx-aut flex items-center justify-center px-5 py-5"
      {...props}
    >
      <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-2xl w-full overflow-hidden max-w-5xl">
            ...
            <div>
              <div className="flex -mx-3">
                <div className="w-1/2 px-3 mb-5">
                  <label className="text-xs font-semibold px-1">Vorname</label>
                  <div className="flex">
                ...
                <div className="w-1/2 px-3 mb-5">
                  <label className="text-xs font-semibold px-1">Nachname</label>
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                      <i className="mdi mdi-account-outline text-gray-400 text-lg"></i>
                    </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-12">
                  <label className="text-xs font-semibold px-1">Passwort</label>
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
