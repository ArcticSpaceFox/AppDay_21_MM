  ...
  return (
    ...
    >
      <div className="relative">
        <div className="card bg-indigo-200 shadow-lg  w-full h-full rounded-3xl absolute  transform -rotate-6"></div>
        <div className="relative bg-gray-100 text-gray-500 rounded-3xl shadow-2xl w-full overflow-hidden max-w-5xl">
